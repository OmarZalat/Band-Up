    ...
    <>
      ...
      <div id="privacy_policy_wrapper">
        <div id="privacy_policy">
          ...
          <br></br>
          <p>
            This privacy policy sets out how BandUp uses and protects any
            information that you give BandUp when you use this website. BandUp
          ...
          <p>
            BandUp may change this policy from time to time by updating this
            page. You should check this page from time to time to ensure that
            you are happy with any changes. This policy is effective from the
            date of publication.
          </p>
          <br></br>
